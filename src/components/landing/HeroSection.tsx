      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-2xl font-bold text-brand-accent mb-4">Tahun Ajaran 2026/2027</p>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-5 border border-white/20">
              ...
              <div className="text-blue-100 text-sm space-y-1">
                <p>Pendaftaran: <strong className="text-white">Rp 150.000</strong></p>
                <p>Kuliah: <strong className="text-white">Rp 3 Juta/Semester</strong></p>
                <p className="text-xs text-blue-200">(Bisa dicicil Rp 500.000/bulan)</p>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-5 border border-white/20">
              <div className="flex items-center gap-3 mb-2">
