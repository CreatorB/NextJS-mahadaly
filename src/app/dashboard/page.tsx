...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-6 sm:p-8 space-y-6">
      ...
      {linkGroup && (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-green-600 p-5 shadow-md">
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-green-100">Grup WhatsApp Angkatan</p>
                <p className="mt-0.5 text-base font-bold text-white">Bergabunglah sekarang</p>
                <p className="mt-0.5 text-xs text-green-100">Pembayaran Anda telah dikonfirmasi. Klik untuk masuk grup.</p>
              </div>
            </div>
            <a
              href={linkGroup}
              ...
              className="inline-flex items-center gap-2 self-start sm:self-auto rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-green-700 shadow-sm transition hover:bg-green-50 active:scale-95"
            >
